                ...
                home: function() {
                    return {
                        ...
                        preActivities: [
                            ...
                            { access: 'middleware-end', correlationId: '2', name: 'expressInit', paths: ['/'], headers: [{ op: 'set', name: 'x-powered-by', values: ['Express'] }], result: 'next' },
                            ...
                            { access: 'middleware-end', correlationId: '4', name: 'jsonParser', displayName: 'JSON Body Parser', packageName: 'body-parser', paths: ['/'], headers: [{ op: 'set', name: 'content-type', values: ['application/json']}], result: 'next' },
                            ...
                            { access: 'middleware-end', correlationId: '5', name: 'urlencodedParser', displayName: 'URL-Encoded Body Parser', packageName: 'body-parser', paths: ['/'], headers: [{ op: 'set', name: 'content-type', values: ['application/xml']}], result: 'next' },
                            ...
                            { access: 'middleware-end', correlationId: '10', name: '<anonymous>', paths: ['/:id'], method: 'GET', params: { id: '1' }, headers: [{ op: 'set', name: 'content-type', values: ['text/html; charset=utf-8']}, { op: 'set', name: 'content-length', values: ['1478']}, { op: 'set', name: 'etag', values: ['W/"5c6-KfLI6FEDrv9C6HycXY0IbA"']}], result: 'end' },
                            { access: 'middleware-end', correlationId: '9', name: 'router', paths: ['/users'], headers: [{ op: 'set', name: 'content-type', values: ['text/html; charset=utf-8']}, { op: 'set', name: 'content-length', values: ['1478']}, { op: 'set', name: 'etag', values: ['W/"5c6-KfLI6FEDrv9C6HycXY0IbA"']}], result: 'end' },
                            { access: 'SQL', operation: 'Select', target: 'Albums', affected: 1, command: 'SELECT TOP (2) \n[Extent1].[AlbumId] AS [AlbumId], \n[Extent1].[GenreId] AS [GenreId], \n[Extent1].[ArtistId] AS [ArtistId], \n[Extent1].[Title] AS [Title], \n[Extent1].[Price] AS [Price], \n[Extent1].[AlbumArtUrl] AS [AlbumArtUrl]\nFROM [dbo].[Albums] AS [Extent1]\nWHERE [Extent1].[AlbumId] = 1 /* @p0 */' },
                            { access: 'mongo', type: 'data-mongodb-read', operation: 'toArray', query: {}, options: { find: 'MusicStore.AlbumCollection', limit: 0, skip: 0, query: {}, slaveOk: true, readPreference: { mode: 'primary' } }, connectionHost: 'localhost', connectionPort: 27017, database: 'MusicStore', collection: 'AlbumCollection' }
                        ],
                        activities: [
